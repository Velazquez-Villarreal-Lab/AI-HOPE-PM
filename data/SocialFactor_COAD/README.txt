...
The colon cancer dataset includes various social factors that may influence patient outcomes. It records alcohol use (alcohol_use), ranging from never to heavy use. Marital status (marital_status) includes categories like married, single, divorced, and widowed. Financial strain (financial_strain) is assessed from no issues to severe difficulty affording care. Social support (social_support) is classified from strong to no support, while social isolation (social_isolation) is noted from never to always. Food insecurity (food_insecurity) is categorized from no issues to frequent insufficiency. Race and ethnicity (race_ethnicity) include multiple groups, such as Non-Hispanic White, Black/African American, Hispanic/Latino, and others. Gender options (gender) include male, female, non-binary, and prefer not to say. CRC screening adherence (screening_adherence) is tracked as completed on time, delayed, or never completed. Employment status (employment_status) covers full-time and part-time work, unemployment, retirement, disability, and student status. Healthcare access (healthcare_access) is described from easy to no access. Pain burden (pain_burden) is classified from none to severe. Lastly, health literacy (health_literacy) is measured as high, moderate, or low.